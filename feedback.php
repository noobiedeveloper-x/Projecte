...
<body>
    ...
    <!---
        Content for the Feedback Updated 12/1/2023
        Fix 12/2/2023 - Clyde
    --->
    <section class="dashboard">
        ...
        <div class="dash-content">
            <?php
               $sql = "SELECT id, name, email, message, NewDateColumn FROM feedback";
        ...
        <br>
        <h1 class ="tittlePage">USER FEEDBACK</h1>
        <br>    
            <br>
        <?php 
foreach ($data as $row){
echo '<div class="stickyNote">';
  echo '<div class="stickyTitle">';
    echo '<p class ="feeds">'.'Feedback from:' . $row['name'].'</p>';
  echo '</div>';
  echo '<div class="stickyContent">';
...
<!--DARK MODE SCRIPT DEFAULT DO NOT EDIT
 TO AVOID JS ERROR ON CONSOLE
-->
   <Script>
